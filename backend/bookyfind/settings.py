"""
Django settings for bookyfind project.
...
SECRET_KEY = 'django-insecure-=!hx+(r94n_hjo7wyb&sgc98=b7$xs62n6ij!-a%fm1@fc(4=4'
...
WSGI_APPLICATION = 'bookyfind.wsgi.application'
